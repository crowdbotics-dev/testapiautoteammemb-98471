...
## Project Structure
    ...
    ├── testapiautoteammemb_98471  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_98471`
...
2. Clone this repo and `cd testapiautoteammemb_98471`
